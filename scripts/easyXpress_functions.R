...
# it is also imprtant to be sure that your output.csv files are named as your model
...
# this function creates 4 dataframes of interest
...
#all<- process(flag_lab, Metadata_Hour, Metadata_Well)

processed_sum <- all$summarized_processed

#######################################
##### easyXpress wrapper function #####
#######################################

### dont forget to load prior functions first... ####
